...
describe('lifecycle invariants', () => {
  ...
  // existed; empirically it does not. We document this in the lifecycle invariants notes
  ...
  // documented in the lifecycle invariants notes under "Known behaviors that look
  ...
  // The unsupported case is documented in the lifecycle invariants notes as a
  ...
  // the documented lifecycle and action constraints.
  // =========================================================================
