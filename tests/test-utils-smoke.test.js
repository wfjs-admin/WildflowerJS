  ...
  describe('Core Utilities', () => {
    describe('getDistMode', () => {
      it('should return a valid distribution mode', () => {
        ...
        expect(['source', 'core', 'nano', 'mini', 'mini-pool', 'lite', 'spa', 'full', 'ai', 'experimental', 'core-dev', 'nano-dev', 'mini-dev', 'mini-pool-dev', 'lite-dev', 'spa-dev', 'full-dev', 'ai-dev', 'experimental-dev', 'core-raw', 'nano-raw', 'mini-raw', 'mini-pool-raw', 'lite-raw', 'spa-raw', 'full-raw', 'core-min', 'nano-min', 'mini-min', 'mini-pool-min', 'lite-min', 'spa-min', 'full-min', 'experimental-min']).toContain(mode)
      })
      ...
      it('should default to ai-dev mode', () => {
        ...
        expect(['core', 'nano', 'mini', 'mini-pool', 'lite', 'spa', 'full', 'ai', 'experimental', 'core-dev', 'nano-dev', 'mini-dev', 'mini-pool-dev', 'lite-dev', 'spa-dev', 'full-dev', 'ai-dev', 'experimental-dev', 'core-raw', 'nano-raw', 'mini-raw', 'mini-pool-raw', 'lite-raw', 'spa-raw', 'full-raw', 'core-min', 'nano-min', 'mini-min', 'mini-pool-min', 'lite-min', 'spa-min', 'full-min', 'experimental-min']).toContain(mode)
      })
    })
