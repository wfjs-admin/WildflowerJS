/**
 * Verifies an external report that `data-bind-class="{ shared: isShared }"`
...
describe('data-bind-class object syntax in data-list scope (external repro)', () => {
    let testContainer
    let cleanup
    let componentRef
    ...
    it('A. UNPARENTHESIZED object syntax + item-level computed (reported pattern)', async () => {
