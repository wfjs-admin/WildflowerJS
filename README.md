...
<!-- Lite (smaller — no plugins, portals, or transitions) -->
...
Pin a specific version with `wildflowerjs@1.0.0`.
...
| `wildflower.lite.min.js` | Core minus plugins, portals, transitions | Minimal footprint |
