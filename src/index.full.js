/**
 * WildflowerJS - Full Package Entry Point
 *
 * Includes core framework plus RouteManager and SSRManager.
 * This is the complete package for full-stack applications.
 *
 * @module WildflowerJS/Full
 */
...
import { SSRManager, SSRProtectionContext, SSRPhase } from './ssr/SSRManager.js';
...
// Attach SSRManager to wildflower namespace
wildflower.SSRManager = SSRManager;
wildflower.SSRProtectionContext = SSRProtectionContext;
